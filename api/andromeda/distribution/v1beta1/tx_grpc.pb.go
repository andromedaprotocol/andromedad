...
const (
	Msg_SetWithdrawAddress_FullMethodName          = "/andromeda.distribution.v1beta1.Msg/SetWithdrawAddress"
	Msg_WithdrawDelegatorReward_FullMethodName     = "/andromeda.distribution.v1beta1.Msg/WithdrawDelegatorReward"
	Msg_WithdrawValidatorCommission_FullMethodName = "/andromeda.distribution.v1beta1.Msg/WithdrawValidatorCommission"
	Msg_FundCommunityPool_FullMethodName           = "/andromeda.distribution.v1beta1.Msg/FundCommunityPool"
	Msg_UpdateParams_FullMethodName                = "/andromeda.distribution.v1beta1.Msg/UpdateParams"
	Msg_CommunityPoolSpend_FullMethodName          = "/andromeda.distribution.v1beta1.Msg/CommunityPoolSpend"
	Msg_DepositValidatorRewardsPool_FullMethodName = "/andromeda.distribution.v1beta1.Msg/DepositValidatorRewardsPool"
	Msg_FundRewardsPool_FullMethodName             = "/andromeda.distribution.v1beta1.Msg/FundRewardsPool"
)
...
func (c *msgClient) FundRewardsPool(ctx context.Context, in *MsgFundRewardsPool, opts ...grpc.CallOption) (*MsgFundRewardsPoolResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_FundRewardsPool_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedMsgServer) FundRewardsPool(context.Context, *MsgFundRewardsPool) (*MsgFundRewardsPoolResponse, error) {
...
func _Msg_FundRewardsPool_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_FundRewardsPool_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
