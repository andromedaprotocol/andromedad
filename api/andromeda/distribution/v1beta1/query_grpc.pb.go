...
const (
	Query_Params_FullMethodName                      = "/andromeda.distribution.v1beta1.Query/Params"
	Query_ValidatorDistributionInfo_FullMethodName   = "/andromeda.distribution.v1beta1.Query/ValidatorDistributionInfo"
	Query_ValidatorOutstandingRewards_FullMethodName = "/andromeda.distribution.v1beta1.Query/ValidatorOutstandingRewards"
	Query_ValidatorCommission_FullMethodName         = "/andromeda.distribution.v1beta1.Query/ValidatorCommission"
	Query_ValidatorSlashes_FullMethodName            = "/andromeda.distribution.v1beta1.Query/ValidatorSlashes"
	Query_DelegationRewards_FullMethodName           = "/andromeda.distribution.v1beta1.Query/DelegationRewards"
	Query_DelegationTotalRewards_FullMethodName      = "/andromeda.distribution.v1beta1.Query/DelegationTotalRewards"
	Query_DelegatorValidators_FullMethodName         = "/andromeda.distribution.v1beta1.Query/DelegatorValidators"
	Query_DelegatorWithdrawAddress_FullMethodName    = "/andromeda.distribution.v1beta1.Query/DelegatorWithdrawAddress"
	Query_CommunityPool_FullMethodName               = "/andromeda.distribution.v1beta1.Query/CommunityPool"
)
