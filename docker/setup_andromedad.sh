...
echo "$PASSWORD" | andromedad add-genesis-account validator "1000000000$ANDR,1000000000$FEE"

# (optionally) add a few more genesis accounts
for addr in "$@"; do
  echo $addr
  andromedad add-genesis-account "$addr" "1000000000$ANDR,1000000000$FEE"
done
