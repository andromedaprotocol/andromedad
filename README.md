...
[![Go Report Card](https://goreportcard.com/badge/github.com/andromedaprotocol/andromedad)](https://goreportcard.com/report/github.com/andromedaprotocol/andromedad)
[![license](https://img.shields.io/github/license/CosmWasm/wasmd.svg)](https://github.com/andromedaprotocol/andromedad/blob/master/LICENSE)
[![LoC](https://tokei.rs/b1/github/CosmWasm/wasmd)](https://github.com/andromedaprotocol/andromedad)
<!-- [![GolangCI](https://golangci.com/badges/github.com/andromedaprotocol/andromedad.svg)](https://golangci.com/r/github.com/andromedaprotocol/andromedad) -->
...
make test
```
if you are using a linux without X or headless linux, look at [this article](https://ahelpme.com/linux/dbusexception-could-not-get-owner-of-name-org-freedesktop-secrets-no-such-name) or [#31](https://github.com/andromedaprotocol/andromedad/issues/31#issuecomment-577058321).
...
* `-X github.com/andromedaprotocol/andromedad/app.NodeDir=.corald` - set the config/data directory for the node (default `~/.wasmd`)
* `-X github.com/andromedaprotocol/andromedad/app.Bech32Prefix=coral` - set the bech32 prefix for all accounts (default `wasm`)
* `-X github.com/andromedaprotocol/andromedad/app.ProposalsEnabled=true` - enable all x/wasm governance proposals (default `false`)
* `-X github.com/andromedaprotocol/andromedad/app.EnableSpecificProposals=MigrateContract,UpdateAdmin,ClearAdmin` - 
