...
## [\#196](https://github.com/andromedaprotocol/andromedad/issues/196) - Move history of contract code migrations to their own prefix store
...
### CLI
`andromedad query wasm contract-history [bech32_address] to print all the code changes.`
Example:
`andromedad query wasm contract-history cosmos18r5szma8hm93pvx6lwpjwyxruw27e0k5uw835c` 
```json
[
  {
    "operation": "Init",
