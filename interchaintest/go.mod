module github.com/andromedaprotocol/andromedad/interchaintest
...
replace (
	...
	// github.com/andromedaprotocol/andromedad => ../.

	// api breaking change in v0.38.12, so reverting back so ICT is happy with
	// go/pkg/mod/github.com/cometbft/cometbft@v0.38.12/crypto/secp256k1/secp256k1.go:132:9: assignment mismatch: 1 variable but ecdsa.SignCompact returns 2 values
