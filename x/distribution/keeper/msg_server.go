...
func (k msgServer) DepositValidatorRewardsPool(ctx context.Context, msg *types.MsgDepositValidatorRewardsPool) (*types.MsgDepositValidatorRewardsPoolResponse, error) {
	...
	if validator == nil {
		return nil, errors.Wrapf(sdkdistrtypes.ErrNoValidatorExists, msg.ValidatorAddress)
	}
...
// FundRewardsPool implements types.MsgServer.
// Subtle: this method shadows the method (Keeper).FundRewardsPool of msgServer.Keeper.
func (k msgServer) FundRewardsPool(ctx context.Context, msg *types.MsgFundRewardsPool) (*types.MsgFundRewardsPoolResponse, error) {
	...
	if err := k.Keeper.FundRewardsPool(sdkCtx, msg.Amount, depositer); err != nil {
		return nil, err
	}
