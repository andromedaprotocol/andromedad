...
import (
	...
	"github.com/andromedaprotocol/andromedad/x/andromedad"
...
func TestGenesis(t *testing.T) {
	...
	andromedad.InitGenesis(ctx, *k, genesisState)
	got := andromedad.ExportGenesis(ctx, *k)
