...
import AndromedadAndromedadNibtdfvas from './andromedad/andromedad.nibtdfvas'
...
export default { 
  AndromedadAndromedadNibtdfvas: load(AndromedadAndromedadNibtdfvas, 'andromedad.nibtdfvas'),
